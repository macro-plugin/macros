import { isMacroPlugin, transformAsync, createSwcPlugin, getSpanOffset } from '@macro-plugin/core';
import { transformSync, transform } from '@swc/core';
import { existsSync, readFile, writeFile, readFileSync, rm } from 'fs';
...
const importLib = (moduleId, dir = CWD) => createRequire(path$2.resolve(dir, "noop.js"))(moduleId);
