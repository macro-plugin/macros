...
import { buildTransformOptions, createFilter, SCRIPT_EXTENSIONS, createTsLib, resolveTsOptions, createTsResolver, createResolver, matchScriptType, patchTsOptions, getIdMatcher, getHasModuleSideEffects } from '@macro-plugin/shared';
