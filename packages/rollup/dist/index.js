...
async function rollupMacroPlugin(config) {
    ...
    const plugin = {
        ...
        async transform(code, id) {
            ...
            if (id.endsWith(".js")) {
                const result = await core.transformAsync(code, macroOptions);
                return {
                    code: result.code,
                    map: result.map
                };
            ...
            if (isTs || isJsx) {
                const plugin = core.createSwcPlugin(macroOptions, code, core.getSpanOffset());
                ...
                const result = await core$1.transform(code, options);
                return {
                    code: result.code,
                    map: result.map
                };
