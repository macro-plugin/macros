import type { ArrayExpression, BooleanLiteral, CallExpression, Expression, KeyValueProperty, NullLiteral, NumericLiteral, ObjectExpression, Span } from "@swc/core"
...
// TODO: add span support for macros
...
export const $ImportSpecifier = createExprMacro("$ImportSpecifier", function ([local, imported, isTypeOnly = $False]) {
  return createAst("ImportSpecifier", { local, imported, isTypeOnly }, this.span())
}, "(local: import(\"@swc/core\").Identifier, imported?: import(\"@swc/core\").ModuleExportName, isTypeOnly?: boolean) => import(\"@swc/core\").NamedImportSpecifier").proxy(createImportSpecifier)
...
export const $ExportSpecifier = createExprMacro("$NamedExportSpecifier", function ([orig, exported, isTypeOnly = $False]) {
  return createAst("ExportSpecifier", { orig, exported, isTypeOnly }, this.span())
}, "(orig: import(\"@swc/core\").ModuleExportName, exported?: import(\"@swc/core\").ModuleExportName, isTypeOnly?: boolean) => import(\"@swc/core\").NamedExportSpecifier").proxy(createExportSpecifier)
...
export const $RestElement = createExprMacro("$RestElement", function ([argument, typeAnnotation]) {
  const span = this.span()
  return createAst("RestElement", { argument, rest: createSpanAst(span), typeAnnotation }, span)
}, "(argument: import(\"@swc/core\").Pattern, typeAnnotation?: import(\"@swc/core\").TsTypeAnnotation) => import(\"@swc/core\").RestElement").proxy(createRestElement)
