...
export declare const createVariableDeclaration: (kind: VariableDeclarationKind, declare: boolean, declarations: VariableDeclarator[]) => {
...
export declare const createVariableDeclarator: (id: Pattern, definite: boolean, init?: Expression) => {
...
export declare const createOptionalChainingExpression: (base: MemberExpression | OptionalChainingCall, questionDotToken: Span) => {
...
export declare const createImportDeclaration: (specifiers: ImportSpecifier[], source: StringLiteral, typeOnly?: boolean, asserts?: ObjectExpression) => {
...
export declare const createTsTypePredicate: (paramName: TsThisTypeOrIdent, asserts?: boolean, typeAnnotation?: TsTypeAnnotation) => {
