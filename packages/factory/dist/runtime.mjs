...
const createVariableDeclaration = (kind, declare, declarations) => ({
...
const createVariableDeclarator = (id, definite, init) => ({
...
const createOptionalChainingExpression = (base, questionDotToken) => ({
...
const createSpreadElement = (args, spread) => ({
    type: "SpreadElement",
    spread,
    arguments: args,
});
...
const createImportDeclaration = (specifiers, source, typeOnly = false, asserts) => ({
...
const createTsTypePredicate = (paramName, asserts = false, typeAnnotation) => ({
