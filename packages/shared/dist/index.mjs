import { existsSync, readFileSync, writeFile, rm, readFile, statSync, readdirSync } from 'fs';
...
export { addHook, applyMacroOptions, applySwcOptions, autoRequire, buildTransformOptions, buildTransformOptionsSync, extractFiles, extractInput, extractSwcOptions, hasProp, hookRequire, isModule, loadConfigFile, loadConfigFileSync, matchPattern, picomatch, transformConfig, writeDts };
