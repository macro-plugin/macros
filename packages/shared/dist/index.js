...
const matchPattern = (pattern, options = { cwd: process.cwd(), ignore: [] }) => {
    ...
    function globDirectory(dirname, isMatch, ignoreDirMatch, options) {
        ...
        for (const file of list) {
            const resolvePath = path$2.resolve(dirname, file);
            const fileStat = fs.statSync(resolvePath);
    ...
    return globDirectory(entryDir, picomatch(pattern, {
...
exports.applyMacroOptions = applyMacroOptions;
exports.applySwcOptions = applySwcOptions;
