import { Config, MacroOptions } from '@macro-plugin/core';
...
declare function autoRequire<T>(id: string): Promise<Awaited<T>>;
...
declare function applySwcOptions(config: Config): Options$1;
declare function applyMacroOptions(config: Config): Config;
...
export { MatchOptions, addHook, applyMacroOptions, applySwcOptions, autoRequire, buildTransformOptions, buildTransformOptionsSync, extractFiles, extractInput, extractSwcOptions, hasProp, hookRequire, isModule, loadConfigFile, loadConfigFileSync, matchPattern, picomatch, transformConfig, writeDts };
