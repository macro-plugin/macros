...
const importLib = (moduleId, dir = CWD) => require$$0.createRequire(path$2.resolve(dir, "noop.js"))(moduleId);
...
async function createTransformer(inputOptions) {
    ...
    const cacheKeyFunction = _default([], [core$1.version, version, JSON.stringify(inputOptions), configPath ? require$$1.readFileSync(configPath).toString() : ""]);
    ...
    return {
        ...
        process(src, filename, jestOptions) {
            ...
            const offset = core.getSpanOffset();
            return core$1.transformSync(src, Object.assign(Object.assign({}, computedSwcOptions), { module: Object.assign(Object.assign({}, computedSwcOptions.module), { type: (jestOptions.supportsStaticESM ? "es6" : "commonjs") }), plugin: core.createSwcPlugin(macroOptions, src, offset), filename }));
        },
        async processAsync(src, filename, jestOptions) {
            insertInstrumentOptions(jestOptions, !!canInstrument, computedSwcOptions, instrumentOptions);
            const offset = core.getSpanOffset();
            return await core$1.transform(src, Object.assign(Object.assign({}, computedSwcOptions), { module: Object.assign(Object.assign({}, computedSwcOptions.module), { 
                    // async transform is always ESM
                    type: "es6" }), plugin: core.createSwcPlugin(macroOptions, src, offset), filename }));
        },
